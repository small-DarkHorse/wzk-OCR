    ...
    private void recIDCard(String idCardSide, String filePath) {
        ...
        OCR.getInstance(this).recognizeIDCard(param, new OnResultListener<IDCardResult>() {
            ...
            public void onResult(IDCardResult result) {
                //正面{direction=0, wordsResultNumber=6, address=河南省柘城县大仵乡张小村张堂032号, idNumber=411424199403149215, birthday=19940314, name=张德宇, gender=男, ethnic=汉}
                //反面{, signDate=20170502, expiryDate=20270502, issueAuthority=柘城县公安局}
                if (result != null) {
